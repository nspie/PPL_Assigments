...
// HW3
export const parseTraceExp: (params: Sexp[]) => Result<TraceExp> = (params) => 
    params.length !== 1 ? makeFailure("not a TraceExp string") :
    mapv(mapResult(parseL4CExp, params), (CexpS: CExp[]) => makeTraceExp(CexpS[0] as VarRef));
